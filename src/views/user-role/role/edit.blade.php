                ...
                <form method="POST" action="{{ url($route.'role') }}" id="role-form-submit">
                    ...
                    <div class="card-body">                                
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $role->name }}" placeholder="ex - Admin">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ $role->slug }}" placeholder="ex - admin">
                                @error('slug')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
